...
urlpatterns = [
    ...
    path('user_create/', views.LabUserCreate.as_view(), name='user_create'),
    ...
    path('user_create/approval_complete/<token>/', views.UserCreateApprovalComplete.as_view(),
         name='user_create_approval_complete'),
